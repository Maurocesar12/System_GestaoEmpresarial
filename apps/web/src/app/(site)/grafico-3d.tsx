...
export function Grafico3D() {
  ...
  return (
    <div className={styles.moldura}>
      ...
      {/*
        As duas placas flutuantes de propósito não têm dado ligado à etapa
        atual — são a mesma reforçada o tempo todo, "saindo" das bordas do
        mockup para dar profundidade. `pointer-events-none` porque são só
        decoração: um clique ali não deve competir com os botões da tela.
      */}
      <div aria-hidden className={`${styles.flutuante} ${styles.flutuanteTopo}`}>
        <div className={styles.chip}>
          <span className={styles.chipIcone}>
      ...
      <div aria-hidden className={`${styles.flutuante} ${styles.flutuanteBase}`}>
        <div className={styles.chip}>
          <span className={styles.chipIcone}>
            <Link2 aria-hidden />
          </span>
