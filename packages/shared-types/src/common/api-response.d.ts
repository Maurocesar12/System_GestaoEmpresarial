...
export declare const CODIGOS_ERRO: {
  readonly VALIDACAO: 'VALIDACAO';
  readonly NAO_AUTENTICADO: 'NAO_AUTENTICADO';
  readonly SEM_PERMISSAO: 'SEM_PERMISSAO';
  readonly NAO_ENCONTRADO: 'NAO_ENCONTRADO';
  readonly CONFLITO: 'CONFLITO';
  readonly LIMITE_PLANO_EXCEDIDO: 'LIMITE_PLANO_EXCEDIDO';
  readonly TENANT_SUSPENSO: 'TENANT_SUSPENSO';
  readonly MUITAS_REQUISICOES: 'MUITAS_REQUISICOES';
  readonly ERRO_INTERNO: 'ERRO_INTERNO';
};
